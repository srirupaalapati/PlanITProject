...
The test will enter details on the Facebook sign up page and click Sign Up button so it moves the Enter code from Email screen. Asserting whether the Continue button is available to see that the test moved to next screen.
